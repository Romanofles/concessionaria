...
<head>
    ...
    <title>Visualizar Veículos</title>
</head>
<!-- Bootstrap core CSS -->
...
<body>
    ...
    <main>
        ...
        <?php
        $query_usuario = "SELECT id, nome, modelo, marca, tipo, situacao FROM usuario WHERE id = $id LIMIT 1";
        ...
        if (($result_usuario) and ($result_usuario->rowCount() != 0)) {
            ...
            $_SESSION['msg'] = "<p style='color: #f00;'>Erro: Veículo não encontrado!</p>";
